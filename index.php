...
<head>
	...
	<script src="./node_modules/angular-input-masks/releases/angular-input-masks-standalone.min.js" type="text/javascript"></script>
	...
	<script src="./node_modules/angular-input-masks/releases/angular-input-masks.js"></script>
...
<body ng-app="demo">
	<form name="form" ng-controller="ctrl">
		...
		<i>Same as the deprecated <b>ui-cnpj-mask</b></i><br><br>
		...
		<i>Same as the deprecated <b>ui-cpfcnpj-mask</b></i><br><br>
